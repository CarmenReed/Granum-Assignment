...
- Customer-pain framing is grounded in Granum's public marketing surface (per `GRANUM_PORTFOLIO_FACTS.md`), not validated customer interviews. Help-center pages were not crawled.
- Enhancement-5 is conditional on whether Granum ships LLM features today. Treat it as a question for Jonathan, not a recommendation.
